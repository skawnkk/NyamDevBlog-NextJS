...
export const chatMessagesControllerPaginateMessages = (
  ...
  return axiosInstance<void>({ url: `/chats/${cid}/messages`, method: 'GET', params, signal });
};

export const getChatMessagesControllerPaginateMessagesQueryKey = (
  cid: number,
  params?: ChatMessagesControllerPaginateMessagesParams,
) => {
...
export const getChatMessagesControllerPaginateMessagesQueryOptions = <
  TData = Awaited<ReturnType<typeof chatMessagesControllerPaginateMessages>>,
  TError = unknown,
>(
  cid: number,
  params?: ChatMessagesControllerPaginateMessagesParams,
  ...
  const queryKey =
    queryOptions?.queryKey ?? getChatMessagesControllerPaginateMessagesQueryKey(cid, params);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof chatMessagesControllerPaginateMessages>>
  > = ({ signal }) => chatMessagesControllerPaginateMessages(cid, params, signal);
...
export type ChatMessagesControllerPaginateMessagesQueryResult = NonNullable<
  Awaited<ReturnType<typeof chatMessagesControllerPaginateMessages>>
>;
export type ChatMessagesControllerPaginateMessagesQueryError = unknown;

export function useChatMessagesControllerPaginateMessages<
  TData = Awaited<ReturnType<typeof chatMessagesControllerPaginateMessages>>,
  TError = unknown,
>(
  cid: number,
  params: undefined | ChatMessagesControllerPaginateMessagesParams,
  options: {
    query: Partial<
      UseQueryOptions<
        Awaited<ReturnType<typeof chatMessagesControllerPaginateMessages>>,
...
export const chatMessagesControllerPostMessage = (
  ...
  return axiosInstance<void>({
    url: `/chats/${cid}/messages`,
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    data: createChatsMessageDto,
    signal,
  });
};

export const getChatMessagesControllerPostMessageMutationOptions = <
  TError = unknown,
  TContext = unknown,
>(options?: {
...
export type ChatMessagesControllerPostMessageMutationResult = NonNullable<
  Awaited<ReturnType<typeof chatMessagesControllerPostMessage>>
>;
...
export const useChatMessagesControllerPostMessage = <TError = unknown, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof chatMessagesControllerPostMessage>>,
      TError,
