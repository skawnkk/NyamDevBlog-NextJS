...
import type { CommonControllerPostImage200, CommonControllerPostImageBody } from '../schemas';
...
export const getCommonControllerPostImageMutationOptions = <
  TError = unknown,
  TContext = unknown,
>(options?: {
...
export type CommonControllerPostImageMutationResult = NonNullable<
  Awaited<ReturnType<typeof commonControllerPostImage>>
>;
 ...
 * @summary 이미지 업로드
 */
export const useCommonControllerPostImage = <TError = unknown, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof commonControllerPostImage>>,
      TError,
