...
import type { UpdateUserProfileDto } from '../schemas';
...
export const usersControllerGetUsers = (signal?: AbortSignal) => {
  return axiosInstance<void>({ url: `/users`, method: 'GET', signal });
};
...
export const getUsersControllerGetUsersQueryOptions = <
  TData = Awaited<ReturnType<typeof usersControllerGetUsers>>,
  TError = unknown,
>(options?: {
  query?: Partial<
    UseQueryOptions<Awaited<ReturnType<typeof usersControllerGetUsers>>, TError, TData>
  >;
}) => {
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof usersControllerGetUsers>>> = ({
    signal,
  }) => usersControllerGetUsers(signal);
...
export type UsersControllerGetUsersQueryResult = NonNullable<
  Awaited<ReturnType<typeof usersControllerGetUsers>>
>;
...
export const usersControllerGetUser = (id: number, signal?: AbortSignal) => {
  return axiosInstance<void>({ url: `/users/${id}`, method: 'GET', signal });
};
...
>(
  ...
  options?: {
    query?: Partial<
      UseQueryOptions<Awaited<ReturnType<typeof usersControllerGetUser>>, TError, TData>
    >;
  },
) => {
  const { query: queryOptions } = options ?? {};
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof usersControllerGetUser>>> = ({ signal }) =>
    usersControllerGetUser(id, signal);
...
export type UsersControllerGetUserQueryResult = NonNullable<
  Awaited<ReturnType<typeof usersControllerGetUser>>
>;
...
export const useUsersControllerUpdateUser = <TError = unknown, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof usersControllerUpdateUser>>,
      TError,
