...
import type { AccessTokenDto, CreateUserDto } from '../schemas';
 ...
 */
export const authControllerPostTokenAccess = (signal?: AbortSignal) => {
  return axiosInstance<void>({ url: `/auth/token/access`, method: 'POST', signal });
};

export const getAuthControllerPostTokenAccessMutationOptions = <
  TError = unknown,
  TContext = unknown,
>(options?: {
...
export type AuthControllerPostTokenAccessMutationResult = NonNullable<
  Awaited<ReturnType<typeof authControllerPostTokenAccess>>
>;
 ...
 * @summary Access Token 재발급 (헤더로 refresh 토큰 전달)
 */
export const useAuthControllerPostTokenAccess = <TError = unknown, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof authControllerPostTokenAccess>>,
      TError,
 ...
 */
export const authControllerPostRefreshAccess = (signal?: AbortSignal) => {
  return axiosInstance<void>({ url: `/auth/token/refresh`, method: 'POST', signal });
};

export const getAuthControllerPostRefreshAccessMutationOptions = <
  TError = unknown,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type AuthControllerPostRefreshAccessMutationResult = NonNullable<
  Awaited<ReturnType<typeof authControllerPostRefreshAccess>>
>;
 ...
 * @summary Refresh Token 재발급 (쿠키 기반)
 */
export const useAuthControllerPostRefreshAccess = <TError = unknown, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof authControllerPostRefreshAccess>>,
      TError,
 ...
 */
export const authControllerPostLoginWithEmail = (signal?: AbortSignal) => {
  return axiosInstance<AccessTokenDto>({ url: `/auth/login/email`, method: 'POST', signal });
};

export const getAuthControllerPostLoginWithEmailMutationOptions = <
  TError = unknown,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type AuthControllerPostLoginWithEmailMutationResult = NonNullable<
  Awaited<ReturnType<typeof authControllerPostLoginWithEmail>>
>;
 ...
 * @summary 이메일 로그인 (accessToken + refreshToken 쿠키로 반환)
 */
export const useAuthControllerPostLoginWithEmail = <TError = unknown, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof authControllerPostLoginWithEmail>>,
      TError,
...
export const getAuthControllerPostRegisterWithEmailMutationOptions = <
  TError = unknown,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type AuthControllerPostRegisterWithEmailMutationResult = NonNullable<
  Awaited<ReturnType<typeof authControllerPostRegisterWithEmail>>
>;
 ...
 * @summary 이메일 회원가입
 */
export const useAuthControllerPostRegisterWithEmail = <TError = unknown, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof authControllerPostRegisterWithEmail>>,
      TError,
